...
export default function ProjectDetailPage() {
  ...
  if (!project) {
    return <div className="text-white p-12 mt-30 flex justify-center items-center">Project not found.</div>;
  }

  return (
    <section className="relative w-full min-h-screen flex items-center justify-center px-4 mt-40 mb-16 sm:mb-20 md:mb-24 lg:mb-28 text-white z-[25]">
      <div className="w-full max-w-6xl mx-auto bg-white/5 backdrop-blur-sm border border-purple-500/40 rounded-2xl shadow-lg px-4 sm:px-6 md:px-10 lg:px-16 py-8">
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-8 text-center mt-6 leading-snug">
          {project.title}
        </h1>
        ...
        <div className="grid md:grid-cols-2 gap-10 md:gap-20 mb-12">
          <div>
            ...
            <p className="text-sm sm:text-base md:text-[17px] text-[#ADB7BE] leading-relaxed">
              {project.description}
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc list-inside text-sm sm:text-base md:text-[17px] text-[#ADB7BE] leading-relaxed">
        ...
        <div className="mb-12">
          ...
          <ul className="list-disc list-inside text-sm sm:text-base md:text-[17px] text-[#ADB7BE] leading-relaxed pl-4">
        ...
        <div className="mb-12 grid grid-rows-1 sm:grid-rows-2 lg:grid-rows-3 gap-6 text-sm sm:text-base md:text-[17px] text-[#ADB7BE]">
